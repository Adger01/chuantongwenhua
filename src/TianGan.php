...
class TianGan
{
     ...
     * 根据天干获取其对应的五行
     */
    public static function getWuxingByGan($gan)
    {
        return self::$ganWuxing[$gan] ?? "";
    }
     ...
     * 根据天干和月支获取其五行强度系数
     */
    public static function getWeightByTianGanAndMonth($gan, $zhi_month)
    {
        return self::$weight[$gan][$zhi_month] ?: 0;
    }
}
